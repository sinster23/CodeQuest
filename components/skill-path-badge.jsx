...
const SkillsPathPage = () => {
    ...
    javascript: {
      ...
      nodes: [
        ...
        // Row 4 - Expert
        {
          ...
          xp: 200,
          difficulty: 4,
          prerequisites: ["js-adv-1", "js-adv-2"],
          challenges: 8,
        },
        {
          id: "js-expert-2",
          ...
          xp: 200,
          difficulty: 5,
          prerequisites: ["js-adv-2", "js-adv-3"],
          challenges: 10,
        },
        ...
        // Row 5 - Master
        {
          ...
          xp: 300,
          difficulty: 5,
          prerequisites: ["js-expert-1", "js-expert-2"],
          challenges: 12,
        },
      ],
    },
    python: {
      ...
      nodes: [
...

        {
          ...
          xp: 300,
          difficulty: 5,
          prerequisites: ["py-adv-1", "py-adv-2", "py-adv-3"],
          challenges: 12,
        },
      ],
    },
    html: {
      ...
      nodes: [
...

        {
          ...
          xp: 175,
          difficulty: 4,
          prerequisites: ["html-inter-1", "html-inter-2"],
          challenges: 8,
        },
        {
          id: "html-adv-2",
          ...
          xp: 200,
          difficulty: 4,
          prerequisites: ["html-inter-3", "html-inter-4"],
          challenges: 9,
        },

        {
          ...
          xp: 300,
          difficulty: 5,
          prerequisites: ["html-adv-1", "html-adv-2"],
          challenges: 12,
        },
      ],
    },
    react: {
      ...
      nodes: [
        ...
        },
        {
          ...
          xp: 150,
          difficulty: 4,
          prerequisites: ["react-hooks-1", "react-hooks-2"],
          challenges: 8,
        },
        {
          id: "react-router",
...

        {
          ...
          xp: 200,
          difficulty: 5,
          prerequisites: ["react-context", "react-redux"],
          challenges: 8,
        },
        {
          id: "react-advanced",
          ...
          xp: 225,
          difficulty: 5,
          prerequisites: ["react-redux", "react-testing"],
          challenges: 10,
        },

        {
          ...
          xp: 350,
          difficulty: 5,
          prerequisites: ["react-performance", "react-advanced"],
          challenges: 15,
        },
      ],
    },
    algorithms: {
      ...
      nodes: [
        ...
        },
        {
          ...
          xp: 175,
          difficulty: 4,
          prerequisites: ["algo-sort-1", "algo-sort-2"],
          challenges: 8,
        },
        {
          id: "algo-struct-3",
...

        {
          ...
          xp: 275,
          difficulty: 5,
          prerequisites: ["algo-tree-1", "algo-tree-2"],
          challenges: 11,
        },
        {
          id: "algo-advanced-2",
          ...
          xp: 300,
          difficulty: 5,
          prerequisites: ["algo-graph-1", "algo-dp"],
          challenges: 13,
        },
        {
          id: "algo-advanced-3",
...

        {
          ...
          xp: 500,
          difficulty: 5,
          prerequisites: ["algo-advanced-1", "algo-advanced-2", "algo-advanced-3"],
          challenges: 20,
        },
      ],
    },
    databases: {
      ...
      nodes: [
...

        {
          ...
          xp: 350,
          difficulty: 5,
          prerequisites: ["db-queries-1", "db-queries-2", "db-admin", "db-nosql"],
          challenges: 15,
        },
      ],
    },
  ...
  const handleChallengeComplete = (nodeId) => {
    setUserProgress((prev) => ({
      ...
      [selectedLanguage]: {
        ...
        completedNodes: [...prev[selectedLanguage].completedNodes, nodeId],
        currentXP: prev[selectedLanguage].currentXP + (challengeNode?.xp || 0),
      },
    }))
        ...
        <div
          ...
          ${
            status.completed
              ...
              : status.available
                ? "bg-blue-500 border-blue-300 shadow-blue-500/50 hover:bg-blue-400"
  ...
  if (showChallengePage && challengeNode) {
    return (
      <ChallengePageComponent
        nodeId={challengeNode.id}
        nodeName={challengeNode.name}
      ...
      <div className="container mx-auto px-6 py-8 relative z-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="pixel-font text-2xl md:text-4xl font-bold text-purple-400 glow-text">Skills Path</h1>
          </div>
            ...
            <div className="retro-card p-6">
              ...
              <div className="skill-tree-grid relative h-96 md:h-[500px] bg-gradient-to-br from-gray-900/50 to-black/50 rounded border border-gray-600 overflow-hidden">
                ...
                <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ zIndex: 1 }}>
                  {skillTrees[selectedLanguage].nodes.flatMap((node) =>
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-700 h-3 rounded">
                    <div
                      className="progress-bar h-full rounded transition-all duration-500"
                      style={{
                        width: `${(userProgress[selectedLanguage].completedNodes.length / skillTrees[selectedLanguage].nodes.length) * 100}%`,
                      }}
                    ></div>
                  </div>
                </div>
                  ...
                  <div className="text-center">
                    <div className="pixel-font text-lg text-yellow-400 font-bold">
                      {skillTrees[selectedLanguage].nodes.reduce(
                        (total, node) =>
                          userProgress[selectedLanguage].completedNodes.includes(node.id) ? total + 1 : total,
                        0,
                      )}
                    </div>
                        ...
                        {selectedNode.prerequisites.map((prereq) => {
                          ...
                          return (
                            <div key={prereq} className="flex items-center space-x-2">
                              ...
                              <span
                                className={`pixel-font text-xs ${isCompleted ? "text-green-400" : "text-gray-500"}`}
                              >
                                {prereqNode?.name}
                              </span>
                            </div>
